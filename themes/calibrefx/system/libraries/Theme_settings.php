...
class CFX_Theme_Settings extends Calibrefx_Admin {
	...
	public function __construct() {
		...
		$this->default_settings = apply_filters(
			'calibrefx_theme_settings_defaults', array(
				'update'                         => 1,
				'blog_title'                     => 'text',
				'header_right'                   => 0,
				'layout_type'                    => 'static',
	...
	function navigation_box() {
		...
		add_action(
			'themenavigation-settings_options', function() {
	...
	function tracking_setting() {
		...
		add_action(
			'themetracking-settings_options', function() {
				calibrefx_add_meta_option(
	...
	function content_setting() {
		...
		add_action(
			'content-settings_options', function() {
				calibrefx_add_meta_option(
	...
	function comment_setting() {
		...
		add_action(
			'comment-settings_options', function() {
				calibrefx_add_meta_option(
		...
		add_action(
			'comment-settings_options', function() {
				...
				calibrefx_add_meta_option(
					...
					__(
						'You can generally disabled trackback / pingbacks on posts or pages. Uncheck it if you want to disable comment box. <br/>
					 Learn more about WordPress Trackbacks and Pingbacks <a href="https://make.wordpress.org/support/user-manual/building-your-wordpress-community/trackbacks-and-pingbacks/" target="_blank">here</a>', 'calibrefx'
					), // Label
					array(
						'option_type' => 'description',
					), // Settings config
	...
	function layout_box() {
		...
		calibrefx_add_meta_group( 'layout-settings', 'feature-image-settings', __( 'Feature Image Settings', 'calibrefx' ) );
		 ...
		 //For Layout Settings
		add_action(
			'layout-settings_options', function() {
				calibrefx_add_meta_option(
		...
		add_action(
			'layout-settings_options', function() {
				calibrefx_add_meta_option(
					...
					array(
						'option_type'        => 'custom',
						'option_custom'      => calibrefx_layout_selector(
							array(
	...
	function custom_script_box() {
		...
		add_action(
			'themelayout-script-settings_options', function() {
				calibrefx_add_meta_option(
	...
	function socials_integrated_box() {
		...
		add_action(
			'themesocial-settings_options', function() {
				calibrefx_add_meta_option(
